        ...
        <tr>
            <td class="text-center"  style="height: 76px">
                ...
                <table class="nav-justified" style="height: 396px; margin-top: 31px;">
                    <tr>
                        <td class="text-center" style="height: 27px"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Descripción&nbsp;&nbsp;&nbsp;<asp:TextBox ID="DescripcionTextBox" runat="server" Width="221px"></asp:TextBox>
                    ...
                    <tr>
                        <td class="text-center" style="height: 25px"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Precio x Pie&nbsp;&nbsp; <asp:TextBox ID="traTextBox" runat="server" Width="105px"></asp:TextBox>
                    ...
                    <tr>
                        <td class="text-center" style="height: 25px"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="MinimoPieLabel" runat="server" Text="Minimo Pie"></asp:Label>
&nbsp;&nbsp; <asp:TextBox ID="MinimoPieTextBox" runat="server" Width="105px"></asp:TextBox>
                    ...
                    <tr>
                        <td class="text-center" style="height: 25px"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="PreMaxPiePieLabel0" runat="server" Text="Precio Maximo x Pie"></asp:Label>
                            </strong>&nbsp;<strong><asp:TextBox ID="PrecioPieMaximoTextBox1" runat="server" Width="105px"></asp:TextBox>
                            ...
                            </strong>&nbsp;<strong><asp:TextBox ID="MaximoPieTextBox0" runat="server" Width="105px"></asp:TextBox>
                    ...
                    <tr>
                        <td class="text-center" style="height: 37px"><strong>Materiales&nbsp;&nbsp;<asp:DropDownList ID="MaterialesDropDownList" runat="server" Height="22px" Width="166px">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td class="text-center" style="height: 37px">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td style="width: 396px"><strong></strong></td>
                                    <td><strong></strong></td>
                                </tr>
                                <tr>
                                    <td style="width: 396px"><strong></strong></td>
