    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [Contrasena] = @Contrasena, [UserName] = @UserName, [N" +
                "ombre] = @Nombre, [Restriccion] = @Restriccion WHERE (([UsuarioId] = @Original_I" +
                "dUsuario))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UsuarioId, Contrasena, UserName, Nombre, Restriccion FROM dbo.Usuario";
        ...
        public virtual int Update(string Contrasena, string UserName, string Nombre, global::System.Nullable<bool> Restriccion, int Original_UsuarioId) {
            if ((Contrasena == null)) {
